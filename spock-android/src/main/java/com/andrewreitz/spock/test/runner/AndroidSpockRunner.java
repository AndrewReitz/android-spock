 ...
 */
package com.andrewreitz.spock.test.runner;
 ...
 */
public class AndroidSpockRunner extends MonitoringInstrumentation {
  ...
  TestRequest buildRequest(Bundle arguments, PrintStream writer) {
    ...
    SpockTestRequestBuilder builder = createTestRequestBuilder(writer,
   ...
   * Exposed for unit testing.
   */
  SpockTestRequestBuilder createTestRequestBuilder(PrintStream writer, String... packageCodePaths) {
    return new SpockTestRequestBuilder(writer, packageCodePaths);
  }
   ...
   */
  private void parseTestClass(String testClassName, SpockTestRequestBuilder testRequestBuilder) {
   ...
   * @param testRequestBuilder - builder to add tests to
   */
  private void parseTestClassesFromFile(String filePath, SpockTestRequestBuilder testRequestBuilder) {
